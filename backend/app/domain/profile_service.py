...
class UserProfileService:
    ...
    @staticmethod
    def get_recent_activity(user_obj, limit: int = 5) -> List[Dict]:
        """Get recent module activity for the user."""
        from app.models.game_session import GameSession
        from app.models.module import Module
        
        sessions = db.session.query(GameSession, Module.name) \
    ...
    @staticmethod
    def submit_feedback(user_id: int, message: str, rating: int):
